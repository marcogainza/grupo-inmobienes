...
export const metadata: Metadata = {
  ...
  description: "Términos y Condiciones de uso del sitio de Grupo Inmobienes",
};
...
const CLAUSULAS = [
  {
    ...
    body: `El acceso, navegación y uso del sitio web de Grupo Inmobienes implica la aceptación expresa, libre, informada, incondicional y obligatoria de los presentes Términos y Condiciones. Si el usuario no está de acuerdo, deberá abstenerse de utilizar el sitio o proporcionar información personal.\n\nEl uso del sitio genera efectos jurídicos vinculantes en los términos aquí establecidos con respecto a la naturaleza del servicio ofrecido.`,
  },
  {
    n: "02",
    title: "Identificación del Titular",
    body: `El sitio web es operado por Grupo Inmobienes, sociedad legalmente constituida en la República del Ecuador.`,
  },
  {
    n: "03",
    title: "Naturaleza del Modelo de Negocio",
    body: `El usuario declara expresamente que entiende y acepta que:\n\n• Grupo Inmobienes NO es una entidad financiera\n• Grupo Inmobienes NO es banco, cooperativa ni institución de crédito\n• Grupo Inmobienes NO otorga préstamos, créditos ni financiamiento\n• Grupo Inmobienes NO realiza intermediación financiera\n• Grupo Inmobienes NO capta dinero del público como actividad financiera regulada\n\nEl modelo de negocio corresponde exclusivamente a un servicio de COMPRA PROGRAMADA DE BIENES INMUEBLES, de naturaleza comercial, no financiera, sujeto a normativa de la Superintendencia de Compañías, Valores y Seguros del Ecuador conforme a la Resolución No. SCVS-INC-DNCDN-2024-0010 y su reforma No. SCVS-INC-DNCDN-2024-0017. El usuario reconoce que el servicio prestado únicamente tiene dos modalidades de adjudicación: por Sorteo o Licitación. El inmueble que el titular detalle en el formulario únicamente es referencial y no genera obligación alguna a Grupo Inmobienes de entregarlo, y no crea relación comercial alguna hasta la suscripción formal del contrato de gestión de compra programada, cuyo objeto únicamente es la intermediación para la adquisición de un inmueble que es elegido por el titular en caso de ser adjudicado bajo las modalidades antes mencionadas.`,
  },
  {
    n: "04",
